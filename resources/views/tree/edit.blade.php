            ...
            <div class="space-y-4">
                <form action="{{ route('tree.update') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('tree.show', Auth::user()->name) }}" target="_blank"
                ...
                <form action="{{ route('tree.deactivate') }}" method="POST">
                    @csrf
                    <button type="submit" class="px-6 py-2 bg-red-600 text-white text-sm rounded-lg hover:bg-red-700 transition-colors cursor-pointer">
                        Deactivate Tree
                    </button>
                </form>
            </div>
